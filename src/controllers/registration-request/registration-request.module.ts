...
import { DownloadRegistrationRequestQueryHandler } from './query/download-registration-request-query.handler';
import { GetRegistrationRequestByIdQueryHandler } from './query/get-registration-request-by-id.query.handler';
import { SearchRegistrationRequestQueryHandler } from './query/search-registration-request-query.handler';
